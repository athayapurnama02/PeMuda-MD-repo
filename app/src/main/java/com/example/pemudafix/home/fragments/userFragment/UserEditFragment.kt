...
import com.example.pemudafix.databinding.BottomSheetDeleteStudentBinding
import com.example.pemudafix.databinding.FragmentUserEditBinding
import com.example.pemudafix.home.viewmodel.UserEditViewModel
import com.example.pemudafix.util.*
    ...
    private fun setupUI() {
        binding.apply {
            ...
            btnSaveChange.setOnClickListener {
                ...
                if (detailVerification(imageUrl, username, mobile)) {
